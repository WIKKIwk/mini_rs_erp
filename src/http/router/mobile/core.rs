...
pub(super) fn routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/v1/mobile/raw-material-split/issues", axum::routing::post(crate::http::handlers::raw_material_split::report_issue))
        ...
        .route("/v1/mobile/preparation/formula-orders", get(crate::http::handlers::preparation::formula_orders))
        .route("/v1/mobile/preparation/formulas/saved", get(crate::http::handlers::preparation::saved_formula_show)
            .patch(crate::http::handlers::preparation::saved_formula_update)
            .delete(crate::http::handlers::preparation::saved_formula_delete))
        .route("/v1/mobile/preparation/materials", axum::routing::post(crate::http::handlers::preparation::material)
            .get(crate::http::handlers::preparation::list_materials)
            .patch(crate::http::handlers::preparation::rename_material)
            .delete(crate::http::handlers::preparation::delete_material))
        .route("/v1/mobile/preparation/materials/warehouses", axum::routing::patch(crate::http::handlers::preparation::update_material_warehouses))
        .route("/v1/mobile/preparation/warehouses", axum::routing::post(crate::http::handlers::preparation::create_warehouse)
            .patch(crate::http::handlers::preparation::rename_warehouse)
            .delete(crate::http::handlers::preparation::delete_warehouse))
        .route("/v1/mobile/preparation/receipts", axum::routing::post(crate::http::handlers::preparation::receipt))
        .route("/v1/mobile/preparation/receipt-reversals", axum::routing::post(crate::http::handlers::preparation::receipt_reversal))
        ...
        .route("/v1/mobile/qolip/order-products", any(qolip::order_products))
