...
const POSTGRES_MIGRATIONS: [(&str, &str); 132] = [
    (
    ...
    (
        "0088_order_run_session_stage_identity",
        include_str!("../../../migrations/postgres/0088_order_run_session_stage_identity.sql"),
    ),
    (
    ...
    (
        "0092_rezka_lineage_payload_cutover",
        include_str!("../../../migrations/postgres/0092_rezka_lineage_payload_cutover.sql"),
    ),
    (
        "0093_preparation_master",
        include_str!("../../../migrations/postgres/0093_preparation_master.sql"),
    ),
    (
        "0094_qolip_warehouse_ownership",
        include_str!("../../../migrations/postgres/0094_qolip_warehouse_ownership.sql"),
    ),
    (
        "0095_bosma_astatka_reports",
        include_str!("../../../migrations/postgres/0095_bosma_astatka_reports.sql"),
    ),
    (
        "0096_paddon_receipts",
        include_str!("../../../migrations/postgres/0096_paddon_receipts.sql"),
    ),
    (
        "0097_raw_material_split",
        include_str!("../../../migrations/postgres/0097_raw_material_split.sql"),
    ),
    (
        "0098_raw_material_split_weights",
        include_str!("../../../migrations/postgres/0098_raw_material_split_weights.sql"),
    ),
    (
        "0099_raw_material_split_issues",
        include_str!("../../../migrations/postgres/0099_raw_material_split_issues.sql"),
    ),
    (
        "0100_raw_material_split_issue_completion",
        include_str!("../../../migrations/postgres/0100_raw_material_split_issue_completion.sql"),
    ),
    (
        "0101_raw_material_split_output_length",
        include_str!("../../../migrations/postgres/0101_raw_material_split_output_length.sql"),
    ),
    (
    ...
    (
        "0106_preparation_formulas",
        include_str!("../../../migrations/postgres/0106_preparation_formulas.sql"),
    ),
    (
        "0107_preparation_formula_names",
        include_str!("../../../migrations/postgres/0107_preparation_formula_names.sql"),
    ),
    (
        "0108_preparation_material_responsibilities",
        include_str!("../../../migrations/postgres/0108_preparation_material_responsibilities.sql"),
    ),
    (
        "0109_preparation_formula_material_scope",
        include_str!("../../../migrations/postgres/0109_preparation_formula_material_scope.sql"),
    ),
    (
        "0110_material_receipt_length",
        include_str!("../../../migrations/postgres/0110_material_receipt_length.sql"),
    ),
    (
        "0111_telegram_pending_orders",
        include_str!("../../../migrations/postgres/0111_telegram_pending_orders.sql"),
    ),
    (
        "0112_opened_order_edit",
        include_str!("../../../migrations/postgres/0112_opened_order_edit.sql"),
    ),
    (
        "0113_preparation_receipts_catalog_items",
        include_str!("../../../migrations/postgres/0113_preparation_receipts_catalog_items.sql"),
    ),
    (
    ...
    (
        "0116_paddon_inventory_receipt_events",
        include_str!("../../../migrations/postgres/0116_paddon_inventory_receipt_events.sql"),
    ),
    (
        "0117_preparation_material_warehouse_scopes",
        include_str!("../../../migrations/postgres/0117_preparation_material_warehouse_scopes.sql"),
    ),
    (
        "0118_paddon_receipt_line_ledger",
        include_str!("../../../migrations/postgres/0118_paddon_receipt_line_ledger.sql"),
    ),
    (
        "0119_preparation_receipt_reversals",
        include_str!("../../../migrations/postgres/0119_preparation_receipt_reversals.sql"),
    ),
    (
        "0120_print_preflight_holds",
        include_str!("../../../migrations/postgres/0120_print_preflight_holds.sql"),
    ),
    (
        "0121_print_preflight_order_status",
        include_str!("../../../migrations/postgres/0121_print_preflight_order_status.sql"),
    ),
    (
        "0122_production_map_alternative_backfill",
        include_str!("../../../migrations/postgres/0122_production_map_alternative_backfill.sql"),
    ),
    (
        "0123_repair_duplicate_laminate_alternatives",
        include_str!(
            "../../../migrations/postgres/0123_repair_duplicate_laminate_alternatives.sql"
        ),
    ),
    (
        "0124_allow_sessionless_preflight_freeze_targets",
        include_str!(
    ...
    (
        "0126_auth_credentials",
        include_str!("../../../migrations/postgres/0126_auth_credentials.sql"),
    ),
    (
        "0127_preparation_warehouse_management",
        include_str!("../../../migrations/postgres/0127_preparation_warehouse_management.sql"),
    ),
    (
        "0128_preparation_material_management",
        include_str!("../../../migrations/postgres/0128_preparation_material_management.sql"),
    ),
    (
        "0129_admin_access_code_visibility",
        include_str!("../../../migrations/postgres/0129_admin_access_code_visibility.sql"),
    ),
    (
    ...
    (
        "0132_queue_reorder_commands",
        include_str!("../../../migrations/postgres/0132_queue_reorder_commands.sql"),
    ),
];
