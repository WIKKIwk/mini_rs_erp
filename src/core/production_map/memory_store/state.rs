...
pub struct MemoryProductionMapStore {
    ...
    pub(super) active_paddons: RwLock<BTreeMap<(String, String, String), String>>,
    pub(super) paddons: RwLock<BTreeMap<String, PaddonSummary>>,
    ...
    pub(super) bosma_astatka_reports: RwLock<Vec<BosmaAstatkaReport>>,
...
impl MemoryProductionMapStore {
    pub fn new() -> Self {
        Self {
            ...
            active_paddons: RwLock::new(BTreeMap::new()),
            paddons: RwLock::new(BTreeMap::new()),
            progress_batch_corrections: RwLock::new(Vec::new()),
            laminatsiya_astatka_reports: RwLock::new(Vec::new()),
            bosma_astatka_reports: RwLock::new(Vec::new()),
